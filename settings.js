...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=SIsyDCSS#EUti6sztsCJQPTaAJxBnoelwlowDw6M4gNimG-2AiP4' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '27613106647' : process.env.OWNER_NUMBER,   
...
MAX_SIZE: 500, 
ALIVE:  process.env.ALIVE  || 'lm alive and running well'  ,    
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? '263781526148' : process.env.DELETEMSGSENDTO        
};
